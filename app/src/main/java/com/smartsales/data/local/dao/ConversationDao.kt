...
interface ConversationDao {
    ...
    suspend fun updateSummary(id: Long, summary: String?, timestamp: Long = System.currentTimeMillis())
    ...
    suspend fun markAsAnalyzed(id: Long, analyzed: Boolean, timestamp: Long = System.currentTimeMillis())
     ...
     */
    @Transaction
    suspend fun createConversationTransaction(title: String, summary: String? = null): Long {
